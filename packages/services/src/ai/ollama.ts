...
export interface OllamaConfig {
  ...
  generalModel: string;         // Model for general chat (e.g., darkplanet)
  longFormModel: string;        // Model for longer responses (e.g., dolphin-mixtral)
}
...
export interface OllamaOptions {
  // Core Sampling
  temperature?: number;         // 0.0 - 2.0, controls randomness (higher = more creative)
 ...
 */
export function createOllamaGateway(): OllamaGateway {
...
let ollamaGatewayInstance: OllamaGateway | null = null;
